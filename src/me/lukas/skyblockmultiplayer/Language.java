...
public enum Language {
	...
	MSGS_CMDNEWISLAND("msgs.commands.newIsland", "§6/skyblock newIsland §a[player]§7 - give yourself or an other player a new island"),
	...
	MSGS_CMDSETLANGUAGE("msgs.commands.setLanguage", "§6/skyblock set language §c<language>§7 - change language"),
	MSGS_CMDSETGAMEMODE("msgs.commands.setGameMode", "§6/skyblock set gamemode §c<option>§7 - <build> or <pvp>"),
	...
	MSGS_CMDSETOWNER("msgs.commands.setOwner", "§6/skyblock setOwner §c<island number> <player>§7 - change the owner of a island"),
	...
	MSGS_CMDHOMEADD("msgs.commands.homeAdd", "§6/skyblock home add §c<player>§7 - add a player to your friendlist"),
	MSGS_CMDHOMEREMOVE("msgs.commands.homeRemove", "§6/skyblock home remove §c<player>§7 - remove a player from your friendlist"),
	MSGS_CMDHOMEJOIN("msgs.commands.homeJoin", "§6/skyblock home join §c<player>§7 - teleport to a friends island"),
